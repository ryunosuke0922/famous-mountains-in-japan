const data_100FamousMountainsInJapan = [
    {
        no: 1,
        name: "利尻岳",
        kanaName: "りしりだけ",
...
const data_100FamousMountainsInJapan_hokkaido = [
    {
        no: 1,
        name: "利尻岳",
        kanaName: "りしりだけ",
...
const data_100FamousMountainsInJapan_kansai = [
    {
        no: 4,
        name: "大峰山(八経ヶ岳)",
        kanaName: "おおみねさん(はっきょうがたけ)",
...
const data_100FamousMountainsInJapan_elevation = [
    {
        no: 4,
        name: "大峰山(八経ヶ岳)",
        kanaName: "おおみねさん(はっきょうがたけ)",
...
export const get100FamousMountainsInJapan_elevation = () => {
    return data_100FamousMountainsInJapan_elevation;
};
